...
@section('content')
    <div class="flex justify-center">
        <div class="w-full relative bg-white p-6 rounded-lg lg:w-8/12">
            ...
            <form id="assignment-form" class="hidden lg:block lg:relative" action="{{route('assignments')}}" method="post">
                <div class="mb-4">
